...
console.log(" ");
console.log(
  "using the filter function on an array, with another created function as an argument"
);
console.log(
  "this created function iterates over the array and returns true if the element is shorter than 3"
);
...
const generateMessages = (element) => {
  console.log(
    `Hi ${element.name}! ${element.discount}% off our best candies for you today!'`
  );
};
